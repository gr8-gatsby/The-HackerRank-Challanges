...
#     .
#
# Because the total cost of all operations is
# dollars, we print
#
# on a new line.
#
...
# is another string that occurs "in" (Wikipedia). For example, the substrings of the string "" are "", "" ,"", "", "", and "".